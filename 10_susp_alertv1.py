log = '''
2026-06-09 10:01:12 [FAILURE] Email: user.alpha@example.com | IP: 192.168.1.10
...
for line in lines:
    ...
    if split_line[2].strip('[').strip(']') != "SUCCESS":
        failed_login_attempts[split_line[7]] = failed_login_attempts.get(split_line[7],0)+1

print(failed_login_attempts)
# Print alert for top 2 suspected IPs